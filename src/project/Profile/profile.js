...
import {findAllReviews, findReviewsForUser, deleteReview} from "../../services/reviewService"
...
export default class Profile extends React.Component {
    ...
    blockUser = (username) =>
        blockUser(username)
            .then(response => alert(username + ' blocked'))
                            ...
                            {this.state.reviews.map((review) => (
                                ...
                                >
                                    ...
                                    <button className="btn btn-primary"
                                            onClick={() => this.deleteReview(review._id)}>Delete
                                    </button>
                                    <button className="btn btn-primary"
                                            onClick={() => this.blockUser(review.username)}>Block User
                                    </button>
                                </li>
                            ))}
                        </ul>
